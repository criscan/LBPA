...
After running the model (double click on lbpa.exe) you will find several files, being the most interesting: lbpa.rep (results report), lbpa.par, lbpa.std and lbpa.cor.  
